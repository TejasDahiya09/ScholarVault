        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-8">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-5 md:p-6 border border-slate-200 hover:border-indigo-200 hover:shadow-md transition-all duration-200">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50 flex items-center justify-center text-xl sm:text-2xl border border-indigo-100 shrink-0">
                ✉️
              </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-5 md:p-6 border border-slate-200 hover:border-indigo-200 hover:shadow-md transition-all duration-200">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center text-xl sm:text-2xl border border-indigo-100 shrink-0">
                🔒
              </div>
              <div className="flex-1 min-w-0">
